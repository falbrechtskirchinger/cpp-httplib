...
inline ssize_t select_read_impl(socket_t sock, int extra_fd, time_t sec,
...
inline ssize_t select_read(socket_t sock, int extra_fd, time_t sec, time_t usec,
